            ...
            <div id="page-wrapper">
                <PageTitle pageTitle="商品管理">
                    <div className="page-header-right">
                        <Link className="btn btn-primary" href="product/product/preInitProductStcokToRedis.do">预置库存</Link>&nbsp;
                        <Link className="btn btn-primary" href="product/product/preInitProductListToRedis.do">预置商品</Link>&nbsp;
